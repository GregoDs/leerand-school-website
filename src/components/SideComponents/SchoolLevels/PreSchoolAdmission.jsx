...
const ctaButton = (label) => (
  <button
    className="prep-cta-btn group flex items-center gap-3 sm:gap-4 mt-4"
    aria-label={label}
  >
    <span className="text-xs sm:text-sm tracking-widest uppercase text-gray-700">
      {label}
    </span>
    <span className="prep-arrow-circle">
...
export default function PrepSchoolEntry() {
  return (
    <section className="w-full bg-gray-100 py-12 sm:py-16 px-6 sm:px-10 md:px-16 lg:px-24">
       ...
       <div 
        ...
        >
          ...
          <p className="mt-10 sm:mt-12 text-base sm:text-lg text-[#1c1c1c]">
            ...
            <strong className="underline">prep school</strong> at any point during the academic year.
          </p>
          ...
          <div className="mt-10 space-y-4">
            {ctaButton('Prep School Admissions')}
            {ctaButton('Book a Prep School Visit')}
            {ctaButton('Complete Enquiry Form for Prep School')}
            {ctaButton('Register your child for Prep School')}
          </div>
        </div>
